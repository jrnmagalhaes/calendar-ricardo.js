...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<span><span class="fa fa-2x fa-arrow-left"></span></span>');
            var $nextMonthNavIcon = $('<span><span class="fa fa-2x fa-arrow-right"></span></span>');
            ...
            var $currMonthLabel = $('<h5><b>' + monthLabels[month] + '</b> ' + year + '</h5>');
        ...
        function appendDayOfWeekHeader($calendarElement, $tableObj) {
            if ($calendarElement.data('showDays') === true) {
                ...
                $(dowLabels).each(function (index, value) {
                    $dowHeaderRow.append('<th>' + "<h6>" +value+ "</h6>" + '</th>');
                });
                    ...
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        if ($calendarElement.data('showToday') === true) {
                            if (isToday(year, month, currDayOfMonth)) {
                                ...
                                //$dayElement.html('<span class="badge-today">' + currDayOfMonth + '</span>');
                            }
                        }
